...
final class PageItemView: BaseView {
    ...
    let tableView = UITableView().then {
        ...
        $0.register(
            HomeWishTableViewCell.self,
            forCellReuseIdentifier: HomeWishTableViewCell.registerId
        )
    }
    ...
    let collectionView = UICollectionView(
        ...
        layout.itemSize = HomeWishCollectionViewCell.size
        ...
        $0.alpha = 0.0
        $0.register(
            HomeWishCollectionViewCell.self,
            forCellWithReuseIdentifier: HomeWishCollectionViewCell.registerId
        )
    }
